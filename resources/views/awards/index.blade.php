    ...
    <div class="container">
            ...
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header bg-secondary">
                                <h4 class="text-white">Award Icon</h4>
                            </div>
                            <div class="card-body">
                                ...
                                @endif
                                <form action="{{route('award.icon.update',$award_icon_all->id)}}" method="POST">
                                    @csrf
                                    <div class="form-group">
                                        <label>Icon</label>
                                        <input id="icon_input" type="text" name="icon" class="form-control @error('icon') is-invalid @enderror" value="{{$award_icon_all->icon}}" style="border-color:rgb(79, 74, 143)">
                                        @error('icon')
                    ...
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header bg-secondary">
                                <h4 class="text-white">Award Icon List</h4>
                            </div>
                            <div class="card-body">
                                <div >
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr class="text-center">
                                                <td><i class="fa {{$award_icon_all->icon}} fa-2x" aria-hidden="true"></i></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header bg-secondary">
                        <h4 class="text-white">Award Data Add</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="awards_name" class="form-control @error('awards_name') is-invalid @enderror" style="border-color:rgb(79, 74, 143)">
                                        @error('awards_name')
                                            <span class="text-danger">{{$message}}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="award_subtitle" class="form-control @error('award_subtitle') is-invalid @enderror" style="border-color:rgb(79, 74, 143)">
        ...
        {{-- award data list here --}}
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header bg-secondary">
                        <h4 class="card-title text-white">Award Data list</h4>
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Deleted Award</h5>
                                        <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body text-black table-responsive">
                                        <table id="deletedAward_table" class="table table-bordered">
                                            <thead class="table-inverse">
                                                <tr>
                                                    <th>Serial NO.</th>
                                                    <th>Award Name</th>
                                                    <th>Award Subtitle</th>
                                                    <th>Action</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @forelse ($award_delete_all as $award_delete )
                                                    <tr>
                                                        <td>{{$loop->index +1}}</td>
                                                        <td>{{$award_delete->awards_name}}</td>
                                                        <td>{{$award_delete->award_subtitle}}</td>
                                                        <td>
                                                            <div class="btn-group mb-2">
                                                                <a href="{{route('award_restore',$award_delete->id)}}" type="button" class="btn btn-success btn-square btn-xs">Restore</a>
                                                                <a href="{{route('force_delete',$award_delete->id)}}" type="button" class="btn btn-danger btn-square btn-xs">Permanent Delete</a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                @empty
                    ...
                    <div class="card-body">
                        @if (session('award_delete_message'))
                            <div class="alert alert-danger">
                                {{session('award_delete_message')}}
                            </div>
                        @endif
                        <div class="table-responsive">
                            <table id="awardData_table" class="table table-responsive-md">
                                <thead>
                                    <tr>
                                        <th>Serial NO.</th>
                                        <th>Award Name</th>
                                ...
                                <tbody>
                                    @forelse ($award_all_data as $award_data)
                                        <tr>
                                            <td>{{$loop->index+1}}</td>
                                            <td>{{$award_data->awards_name}}</td>
                                            <td>{{$award_data->award_subtitle}}</td>
                                            <td>
                                                <div class="d-flex">
                                                    <a href="{{route('award.edit',$award_data->id)}}" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
                                                    <form action="{{route('award.destroy',$award_data->id)}}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
    ...
    <script>
        // datatable code start here
            $(document).ready( function () {
                $('#awardData_table').DataTable();
            });

            $(document).ready( function () {
                $('#deletedAward_table').DataTable();
            });
        //  datatable code end here

        //  award icon code start here
            $(document).ready( function () {
                $('.award_icon').click(function(){
                    $('#icon_input').val($(this).attr('id'));
                });
            });
        //  award icon code end here
    </script>
@endsection
