...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{'dashboard-css'}}/images/favicon.png">
...
***********************************-->
<!-- Required vendors -->
<script src="{{'dashboard-css'}}/vendor/global/global.min.js"></script>
<script src="{{'dashboard-css'}}/vendor/bootstrap-select/dist/js/bootstrap-select.min.js"></script>
<script src="{{'dashboard-css'}}/js/custom.min.js"></script>
<script src="{{'dashboard-css'}}/js/deznav-init.js"></script>
