...
@section('content')
    <div class="container">
        {{-- education icon area start here --}}
        <div class="row">
            <div class="col-md-12">
                <div class="row">
                    {{-- education icon add here --}}
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header bg-secondary">
                                <h4 class="text-white">Education Icon</h4>
                            </div>
                            <div class="card-body">
                                ...
                                @endif
                                <form action="{{route('education_icon.update',$education_icon_all->id)}}" method="POST">
                                    @csrf
                                    <div class="form-group">
                                        <label>Icon</label>
                                        <input id="icon_input" type="text" name="icon" class="form-control @error('icon') is-invalid @enderror" value="{{$education_icon_all->icon}}" style="border-color:rgb(79, 74, 143)">
                                        @error('icon')
                                        ...
                                        <div class="mt-2" style="height: 150px; overflow-y:scroll;">
                                            ...
                                            @foreach ($all_icons as $all_icon)
                                                <i id="{{$all_icon}}" class="education_icon m-1 p-2 border fa {{$all_icon}}" aria-hidden="true"></i>
                                            @endforeach
                                        </div>
                                    </div>
                    ...
                    {{-- education icon list here --}}
                    <div class="col-md-6">
                        <div class="card">
                            <div class="card-header bg-secondary">
                                <h4 class="text-white">Education Icon List</h4>
                            </div>
                            <div class="card-body">
                                <div >
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr class="text-center">
                                                <td><i class="fa {{$education_icon_all->icon}} fa-2x" aria-hidden="true"></i></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
        ...
        {{-- education data add here --}}
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header bg-secondary">
                        <h4 class="text-white">Education Data Add</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="institution_name" class="form-control @error('institution_name') is-invalid @enderror" style="border-color:rgb(79, 74, 143)">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="qualification_title" class="form-control @error('qualification_title') is-invalid @enderror" style="border-color:rgb(79, 74, 143)">
        ...
        {{-- education data list here --}}
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header bg-secondary">
                        <h4 class="card-title text-white">Education Data list</h4>
                            ...
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Deleted Education</h5>
                                        <button type="button" class="close" data-dismiss="modal"><span>&times;</span>
                                        </button>
                                    </div>
                                    <div class="modal-body text-black table-responsive">
                                        <table id="deleted_education_table" class="table table-bordered">
                                            ...
                                            <tbody>
                                                @forelse ($education_delete_all as $education_delete )
                                                    <tr>
                                                        <td>{{$loop->index +1}}</td>
                                                        <td>{{$education_delete->institution_name}}</td>
                                                        <td>{{$education_delete->qualification_title}}</td>
                                                        <td>
                                                            <div class="btn-group mb-2">
                                                                <a href="{{route('education_restore',$education_delete->id)}}" type="button" class="btn btn-success btn-square btn-xs">Restore</a>
                                                                <a href="{{route('force_delete',$education_delete->id)}}" type="button" class="btn btn-danger btn-square btn-xs">Permanent Delete</a>
                                                            </div>
                                                        </td>
                                                    </tr>
                                                @empty
                    ...
                    <div class="card-body">
                        @if (session('education_delete_message'))
                            <div class="alert alert-danger">
                                {{session('education_delete_message')}}
                            </div>
                        @endif
                        <div class="table-responsive">
                            <table id="educationData_table" class="table table-responsive-md">
                                <thead>
                                    <tr>
                                        <th>Serial NO.</th>
                                        <th>Institution Name</th>
                                ...
                                <tbody>
                                    @forelse ($education_all_data as $educations)
                                        <tr>
                                            <td>{{$loop->index+1}}</td>
                                            <td>{{$educations->institution_name}}</td>
                                            <td>{{$educations->qualification_title}}</td>
                                            <td>
                                            <div class="d-flex">
                                                <a href="{{route('educations.edit',$educations->id)}}" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
...
@section('use-js-code')
    <script>
        ...
        //  education icon code start here
            $(document).ready( function () {
                $('.education_icon').click(function(){
                    $('#icon_input').val($(this).attr('id'));
                });
            });
        //  education icon code end here
    </script>
@endsection
